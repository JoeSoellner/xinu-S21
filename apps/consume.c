...
void consumer_bb(int id, int count) {
	// Iterate from 0 to count and for each iteration read the next available value from the global
	// array `arr_q` print consumer id (starting from 0) and read value as, name : consumer_X, read
	// : X
